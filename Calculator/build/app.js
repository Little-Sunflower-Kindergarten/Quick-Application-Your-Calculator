...
var escape_latex = __webpack_require__(46)
...
var hasOwnProperty = __webpack_require__(5).hasOwnProperty;
var getSafeProperty = __webpack_require__(4).getSafeProperty;

function factory (type, config, load, typed, math) {
  var register = load(__webpack_require__(0)).register;
  var compile = load(__webpack_require__(0)).compile;
  var Node = load(__webpack_require__(2));
...
var getType = __webpack_require__(18).type;
var stringify = __webpack_require__(1).stringify;
var escape = __webpack_require__(1).escape;
...
var validateSafeMethod = __webpack_require__(4).validateSafeMethod;
var getUniqueArgumentName = __webpack_require__(26);

function factory (type, config, load, typed, math) {
  var register = load(__webpack_require__(0)).register;
  var compile = load(__webpack_require__(0)).compile;
  var Node = load(__webpack_require__(2));
  var SymbolNode = load(__webpack_require__(7));
...
var stringify = __webpack_require__(1).stringify;
var escape = __webpack_require__(1).escape;
var isSafeMethod = __webpack_require__(4).isSafeMethod;
var operators = __webpack_require__(8);

function factory (type, config, load, typed) {
  var register = load(__webpack_require__(0)).register;
  var compile = load(__webpack_require__(0)).compile;
  var Node         = load(__webpack_require__(2));
  var ConstantNode = load(__webpack_require__(10));
  var SymbolNode   = load(__webpack_require__(7));
  var FunctionNode = load(__webpack_require__(11));
...
var ArgumentsError = __webpack_require__(42);
var deepMap = __webpack_require__(43);

function factory (type, config, load, typed) {
  var AccessorNode            = load(__webpack_require__(44));
  var ArrayNode               = load(__webpack_require__(25));
  var AssignmentNode          = load(__webpack_require__(48));
  var BlockNode               = load(__webpack_require__(50));
  var ConditionalNode         = load(__webpack_require__(52));
  var ConstantNode            = load(__webpack_require__(10));
  var FunctionAssignmentNode  = load(__webpack_require__(53));
  var IndexNode               = load(__webpack_require__(17));
  var ObjectNode              = load(__webpack_require__(54));
  var OperatorNode            = load(__webpack_require__(14));
  var ParenthesisNode         = load(__webpack_require__(27));
  var FunctionNode            = load(__webpack_require__(11));
...
function factory (type, config, load, typed) {
  ...
  var Range = load(__webpack_require__(47));
...
var getSafeProperty = __webpack_require__(4).getSafeProperty;
var setSafeProperty = __webpack_require__(4).setSafeProperty;
var DimensionError = __webpack_require__(19);
...
function factory(type, config, load, typed, math) {
  var util = load(__webpack_require__(29));
...
_math2.default.import(__webpack_require__(39));

exports.default = {
  showMenu: _util2.default.showMenu,
  createShortcut: _util2.default.createShortcut,
  gcd: _math2.default.gcd,
  cross: _math2.default.cross,
  dot: _math2.default.dot,
  factorial: _math2.default.factorial,
  gamma: _math2.default.gamma,
  isPrime: _math2.default.isPrime,
  lcm: _math2.default.lcm,
  pow: _math2.default.pow,
  kldivergence: _math2.default.kldivergence,
  sin: _math2.default.sin,
  cos: _math2.default.cos,
  tan: _math2.default.tan,
  csc: _math2.default.csc,
  sec: _math2.default.sec,
  format: _math2.default.format,
  integral: _math2.default.integral,
  string: _math2.default.string,
  setCartesian: _math2.default.setCartesian,
  derivative: _math2.default.derivative
};
(exports.default || module.exports).manifest = {"package":"com.LittleSunflowerKindergarten.QuickApplicationCalculator","name":"高等计算器","versionName":"1.0.0","versionCode":"1","minPlatformVersion":"1010","icon":"/Common/logo.png","features":[{"name":"system.prompt"},{"name":"system.router"},{"name":"system.shortcut"},{"name":"system.clipboard"}],"permissions":[{"origin":"*"}],"config":{"logLevel":"debug"},"router":{"entry":"Homepage","pages":{"Homepage":{"component":"index"},"DemoDetail":{"component":"index"},"About":{"component":"index"},"Integral":{"component":"index"},"IsPrime":{"component":"index"},"TheCartesianProduct":{"component":"index"},"Factorial":{"component":"index"},"RelativeEntropy":{"component":"index"},"TrigonometricFunction":{"component":"index"},"Gamma":{"component":"index"},"Cross":{"component":"index"},"Dot":{"component":"index"},"Pow":{"component":"index"},"Lcm":{"component":"index"},"Gcd":{"component":"index"},"Derivative":{"component":"index"},"Constant":{"component":"index"},"Function":{"component":"index"}}},"display":{"backgroundColor":"#ffffff","titleBarBackgroundColor":"#999999","titleBarTextColor":"#ffffff","menu":true,"pages":{"Homepage":{"menu":true,"titleBarText":"主页"},"DemoDetail":{"menu":false,"titleBarText":"详情页"},"About":{"menu":false},"Integral":{"menu":false,"titleBarText":"积分计算（Beta）"},"IsPrime":{"menu":false,"titleBarText":"判断素数"},"TheCartesianProduct":{"menu":false,"titleBarText":"笛卡儿积"},"Factorial":{"menu":false,"titleBarText":"阶乘"},"RelativeEntropy":{"menu":false,"titleBarText":"相对熵"},"TrigonometricFunction":{"menu":false,"titleBarText":"三角函数"},"Gamma":{"menu":false,"titleBarText":"伽玛函数"},"Cross":{"menu":false,"titleBarText":"向量叉积"},"Dot":{"menu":false,"titleBarText":"向量点积"},"Pow":{"menu":false,"titleBarText":"X的Y次幂"},"Lcm":{"menu":false,"titleBarText":"最小公倍数"},"Gcd":{"menu":false,"titleBarText":"最大公约数"},"Derivative":{"menu":false,"titleBarText":"导数计算"},"Constant":{"menu":false,"titleBarText":"常用常量介绍"},"Function":{"menu":false,"titleBarText":"功能介绍"}}}};
}
 ...
 * Copyright (c) 2016, Robert Eisele (robert@xarg.org)
 * Dual licensed under the MIT or GPL Version 2 licenses.
 **/!function(e){"use strict";var n=function n(e){return .5*(Math.exp(e)+Math.exp(-e));},i=function i(e){return .5*(Math.exp(e)-Math.exp(-e));},u=function u(){throw SyntaxError("Invalid Param");};function c(e,t){var r=Math.abs(e),n=Math.abs(t);return 0===e?Math.log(n):0===t?Math.log(r):r<3e3&&n<3e3?.5*Math.log(e*e+t*t):Math.log(e/Math.cos(Math.atan2(t,e)));}var o=function o(e,t){var r={re:0,im:0};if(null==e)r.re=r.im=0;else if(void 0!==t)r.re=e,r.im=t;else switch(typeof e==="undefined"?"undefined":_typeof(e)){case"object":if("im"in e&&"re"in e)r.re=e.re,r.im=e.im;else if("abs"in e&&"arg"in e){if(!Number.isFinite(e.abs)&&Number.isFinite(e.arg))return f.INFINITY;r.re=e.abs*Math.cos(e.arg),r.im=e.abs*Math.sin(e.arg);}else if("r"in e&&"phi"in e){if(!Number.isFinite(e.r)&&Number.isFinite(e.phi))return f.INFINITY;r.re=e.r*Math.cos(e.phi),r.im=e.r*Math.sin(e.phi);}else 2===e.length?(r.re=e[0],r.im=e[1]):u();break;case"string":r.im=r.re=0;var n=e.match(/\d+\.?\d*e[+-]?\d+|\d+\.?\d*|\.\d+|./g),i=1,o=0;null===n&&u();for(var a=0;a<n.length;a++){var s=n[a];" "===s||"\t"===s||"\n"===s||("+"===s?i++:"-"===s?o++:i=o=("i"===s||"I"===s?(i+o===0&&u()," "===n[a+1]||isNaN(n[a+1])?r.im+=parseFloat((o%2?"-":"")+"1"):(r.im+=parseFloat((o%2?"-":"")+n[a+1]),a++)):((i+o===0||isNaN(s))&&u(),"i"===n[a+1]||"I"===n[a+1]?(r.im+=parseFloat((o%2?"-":"")+s),a++):r.re+=parseFloat((o%2?"-":"")+s)),0));}0<i+o&&u();break;case"number":r.im=0,r.re=e;break;default:u();}return isNaN(r.re)||isNaN(r.im),r;};function f(e,t){if(!(this instanceof f))return new f(e,t);var r=o(e,t);this.re=r.re,this.im=r.im;}f.prototype={re:0,im:0,sign:function sign(){var e=this.abs();return new f(this.re/e,this.im/e);},add:function add(e,t){var r=new f(e,t);return this.isInfinite()&&r.isInfinite()?f.NAN:this.isInfinite()||r.isInfinite()?f.INFINITY:new f(this.re+r.re,this.im+r.im);},sub:function sub(e,t){var r=new f(e,t);return this.isInfinite()&&r.isInfinite()?f.NAN:this.isInfinite()||r.isInfinite()?f.INFINITY:new f(this.re-r.re,this.im-r.im);},mul:function mul(e,t){var r=new f(e,t);return this.isInfinite()&&r.isZero()||this.isZero()&&r.isInfinite()?f.NAN:this.isInfinite()||r.isInfinite()?f.INFINITY:0===r.im&&0===this.im?new f(this.re*r.re,0):new f(this.re*r.re-this.im*r.im,this.re*r.im+this.im*r.re);},div:function div(e,t){var r=new f(e,t);if(this.isZero()&&r.isZero()||this.isInfinite()&&r.isInfinite())return f.NAN;if(this.isInfinite()||r.isZero())return f.INFINITY;if(this.isZero()||r.isInfinite())return f.ZERO;e=this.re,t=this.im;var n,i,o=r.re,a=r.im;return 0===a?new f(e/o,t/o):Math.abs(o)<Math.abs(a)?new f((e*(i=o/a)+t)/(n=o*i+a),(t*i-e)/n):new f((e+t*(i=a/o))/(n=a*i+o),(t-e*i)/n);},pow:function pow(e,t){var r=new f(e,t);if(e=this.re,t=this.im,r.isZero())return f.ONE;if(0===r.im){if(0===t&&0<=e)return new f(Math.pow(e,r.re),0);if(0===e)switch((r.re%4+4)%4){case 0:return new f(Math.pow(t,r.re),0);case 1:return new f(0,Math.pow(t,r.re));case 2:return new f(-Math.pow(t,r.re),0);case 3:return new f(0,-Math.pow(t,r.re));}}if(0===e&&0===t&&0<r.re&&0<=r.im)return f.ZERO;var n=Math.atan2(t,e),i=c(e,t);return e=Math.exp(r.re*i-r.im*n),t=r.im*i+r.re*n,new f(e*Math.cos(t),e*Math.sin(t));},sqrt:function sqrt(){var e,t,r=this.re,n=this.im,i=this.abs();if(0<=r){if(0===n)return new f(Math.sqrt(r),0);e=.5*Math.sqrt(2*(i+r));}else e=Math.abs(n)/Math.sqrt(2*(i-r));return t=r<=0?.5*Math.sqrt(2*(i-r)):Math.abs(n)/Math.sqrt(2*(i+r)),new f(e,n<0?-t:t);},exp:function exp(){var e=Math.exp(this.re);return this.im,new f(e*Math.cos(this.im),e*Math.sin(this.im));},expm1:function expm1(){var e=this.re,t=this.im;return new f(Math.expm1(e)*Math.cos(t)+function(e){var t=Math.PI/4;if(e<-t||t<e)return Math.cos(e)-1;var r=e*e;return r*(r*(1/24+r*(-1/720+r*(1/40320+r*(-1/3628800+r*(1/4790014600+r*(-1/87178291200+r*(1/20922789888e3)))))))-.5);}(t),Math.exp(e)*Math.sin(t));},log:function log(){var e=this.re,t=this.im;return new f(c(e,t),Math.atan2(t,e));},abs:function abs(){return e=this.re,t=this.im,r=Math.abs(e),n=Math.abs(t),r<3e3&&n<3e3?Math.sqrt(r*r+n*n):(n=r<n?(r=n,e/t):t/e,r*Math.sqrt(1+n*n));var e,t,r,n;},arg:function arg(){return Math.atan2(this.im,this.re);},sin:function sin(){var e=this.re,t=this.im;return new f(Math.sin(e)*n(t),Math.cos(e)*i(t));},cos:function cos(){var e=this.re,t=this.im;return new f(Math.cos(e)*n(t),-Math.sin(e)*i(t));},tan:function tan(){var e=2*this.re,t=2*this.im,r=Math.cos(e)+n(t);return new f(Math.sin(e)/r,i(t)/r);},cot:function cot(){var e=2*this.re,t=2*this.im,r=Math.cos(e)-n(t);return new f(-Math.sin(e)/r,i(t)/r);},sec:function sec(){var e=this.re,t=this.im,r=.5*n(2*t)+.5*Math.cos(2*e);return new f(Math.cos(e)*n(t)/r,Math.sin(e)*i(t)/r);},csc:function csc(){var e=this.re,t=this.im,r=.5*n(2*t)-.5*Math.cos(2*e);return new f(Math.sin(e)*n(t)/r,-Math.cos(e)*i(t)/r);},asin:function asin(){var e=this.re,t=this.im,r=new f(t*t-e*e+1,-2*e*t).sqrt(),n=new f(r.re-t,r.im+e).log();return new f(n.im,-n.re);},acos:function acos(){var e=this.re,t=this.im,r=new f(t*t-e*e+1,-2*e*t).sqrt(),n=new f(r.re-t,r.im+e).log();return new f(Math.PI/2-n.im,n.re);},atan:function atan(){var e=this.re,t=this.im;if(0===e){if(1===t)return new f(0,1/0);if(-1===t)return new f(0,-1/0);}var r=e*e+(1-t)*(1-t),n=new f((1-t*t-e*e)/r,-2*e/r).log();return new f(-.5*n.im,.5*n.re);},acot:function acot(){var e=this.re,t=this.im;if(0===t)return new f(Math.atan2(1,e),0);var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).atan():new f(0!==e?e/0:0,0!==t?-t/0:0).atan();},asec:function asec(){var e=this.re,t=this.im;if(0===e&&0===t)return new f(0,1/0);var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).acos():new f(0!==e?e/0:0,0!==t?-t/0:0).acos();},acsc:function acsc(){var e=this.re,t=this.im;if(0===e&&0===t)return new f(Math.PI/2,1/0);var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).asin():new f(0!==e?e/0:0,0!==t?-t/0:0).asin();},sinh:function sinh(){var e=this.re,t=this.im;return new f(i(e)*Math.cos(t),n(e)*Math.sin(t));},cosh:function cosh(){var e=this.re,t=this.im;return new f(n(e)*Math.cos(t),i(e)*Math.sin(t));},tanh:function tanh(){var e=2*this.re,t=2*this.im,r=n(e)+Math.cos(t);return new f(i(e)/r,Math.sin(t)/r);},coth:function coth(){var e=2*this.re,t=2*this.im,r=n(e)-Math.cos(t);return new f(i(e)/r,-Math.sin(t)/r);},csch:function csch(){var e=this.re,t=this.im,r=Math.cos(2*t)-n(2*e);return new f(-2*i(e)*Math.cos(t)/r,2*n(e)*Math.sin(t)/r);},sech:function sech(){var e=this.re,t=this.im,r=Math.cos(2*t)+n(2*e);return new f(2*n(e)*Math.cos(t)/r,-2*i(e)*Math.sin(t)/r);},asinh:function asinh(){var e=this.im;this.im=-this.re,this.re=e;var t=this.asin();return this.re=-this.im,this.im=e,e=t.re,t.re=-t.im,t.im=e,t;},acosh:function acosh(){var e=this.acos();if(e.im<=0){var t=e.re;e.re=-e.im,e.im=t;}else{t=e.im;e.im=-e.re,e.re=t;}return e;},atanh:function atanh(){var e=this.re,t=this.im,r=1<e&&0===t,n=1-e,i=1+e,o=n*n+t*t,a=0!==o?new f((i*n-t*t)/o,(t*n+i*t)/o):new f(-1!==e?e/0:0,0!==t?t/0:0),s=a.re;return a.re=c(a.re,a.im)/2,a.im=Math.atan2(a.im,s)/2,r&&(a.im=-a.im),a;},acoth:function acoth(){var e=this.re,t=this.im;if(0===e&&0===t)return new f(0,Math.PI/2);var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).atanh():new f(0!==e?e/0:0,0!==t?-t/0:0).atanh();},acsch:function acsch(){var e=this.re,t=this.im;if(0===t)return new f(0!==e?Math.log(e+Math.sqrt(e*e+1)):1/0,0);var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).asinh():new f(0!==e?e/0:0,0!==t?-t/0:0).asinh();},asech:function asech(){var e=this.re,t=this.im;if(this.isZero())return f.INFINITY;var r=e*e+t*t;return 0!==r?new f(e/r,-t/r).acosh():new f(0!==e?e/0:0,0!==t?-t/0:0).acosh();},inverse:function inverse(){if(this.isZero())return f.INFINITY;if(this.isInfinite())return f.ZERO;var e=this.re,t=this.im,r=e*e+t*t;return new f(e/r,-t/r);},conjugate:function conjugate(){return new f(this.re,-this.im);},neg:function neg(){return new f(-this.re,-this.im);},ceil:function ceil(e){return e=Math.pow(10,e||0),new f(Math.ceil(this.re*e)/e,Math.ceil(this.im*e)/e);},floor:function floor(e){return e=Math.pow(10,e||0),new f(Math.floor(this.re*e)/e,Math.floor(this.im*e)/e);},round:function round(e){return e=Math.pow(10,e||0),new f(Math.round(this.re*e)/e,Math.round(this.im*e)/e);},equals:function equals(e,t){var r=new f(e,t);return Math.abs(r.re-this.re)<=f.EPSILON&&Math.abs(r.im-this.im)<=f.EPSILON;},clone:function clone(){return new f(this.re,this.im);},toString:function toString(){var e=this.re,t=this.im,r="";return this.isNaN()?"NaN":this.isZero()?"0":this.isInfinite()?"Infinity":(0!==e&&(r+=e),0!==t&&(0!==e?r+=t<0?" - ":" + ":t<0&&(r+="-"),1!==(t=Math.abs(t))&&(r+=t),r+="i"),r||"0");},toVector:function toVector(){return[this.re,this.im];},valueOf:function valueOf(){return 0===this.im?this.re:null;},isNaN:function(_isNaN){function isNaN(){return _isNaN.apply(this,arguments);}isNaN.toString=function(){return _isNaN.toString();};return isNaN;}(function(){return isNaN(this.re)||isNaN(this.im);}),isZero:function isZero(){return!(0!==this.re&&-0!==this.re||0!==this.im&&-0!==this.im);},isFinite:function(_isFinite){function isFinite(){return _isFinite.apply(this,arguments);}isFinite.toString=function(){return _isFinite.toString();};return isFinite;}(function(){return isFinite(this.re)&&isFinite(this.im);}),isInfinite:function isInfinite(){return!(this.isNaN()||this.isFinite());}},f.ZERO=new f(0,0),f.ONE=new f(1,0),f.I=new f(0,1),f.PI=new f(Math.PI,0),f.E=new f(Math.E,0),f.INFINITY=new f(1/0,1/0),f.NAN=new f(NaN,NaN),f.EPSILON=1e-16,void 0===(a=function(){return f;}.apply(r,[]))||(t.exports=a);}();},function(e,t,a){"use strict";var s=a(0);t.name="complex",t.factory=function(r,e,t,n){var i=a(4),o=n("complex",{"":function _(){return r.Complex.ZERO;},number:function number(e){return new r.Complex(e,0);},"number, number":function numberNumber(e,t){return new r.Complex(e,t);},"BigNumber, BigNumber":function BigNumberBigNumber(e,t){return new r.Complex(e.toNumber(),t.toNumber());},Complex:function Complex(e){return e.clone();},string:function string(e){return r.Complex(e);},null:function _null(e){return r.Complex(0);},Object:function Object(e){if("re"in e&&"im"in e)return new r.Complex(e.re,e.im);if("r"in e&&"phi"in e||"abs"in e&&"arg"in e)return new r.Complex(e);throw new Error("Expected object with properties (re and im) or (r and phi) or (abs and arg)");},"Array | Matrix":function ArrayMatrix(e){return s(e,o);}});return o.toTex={0:"0",1:"\\left(${args[0]}\\right)",2:"\\left(\\left(${args[0]}\\right)+".concat(i.symbols.i,"\\cdot\\left(${args[1]}\\right)\\right)")},o;};},function(e,t,r){"use strict";var l=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r){Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);}}return e;},p={"{":"\\{","}":"\\}","\\":"\\textbackslash{}","#":"\\#",$:"\\$","%":"\\%","&":"\\&","^":"\\textasciicircum{}",_:"\\_","~":"\\textasciitilde{}"},m={"–":"\\--","—":"\\---"," ":"~","\t":"\\qquad{}","\r\n":"\\newline{}","\n":"\\newline{}"},h=function h(e,t){return l({},e,t);};e.exports=function(e){for(var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},r=t.preserveFormatting,n=void 0!==r&&r,i=t.escapeMapFn,o=void 0===i?h:i,a=String(e),s="",u=o(l({},p),n?l({},m):{}),c=Object.keys(u),f=function f(){var r=!1;c.forEach(function(e,t){r||a.length>=e.length&&a.slice(0,e.length)===e&&(s+=u[c[t]],a=a.slice(e.length,a.length),r=!0);}),r||(s+=a.slice(0,1),a=a.slice(1,a.length));};a;){f();}return s;};},function(e,t,r){"use strict";e.exports=[r(175),r(80)];},function(e,t,r){"use strict";var i=r(176);i.prototype.type="Fraction",i.prototype.isFraction=!0,i.prototype.toJSON=function(){return{mathjs:"Fraction",n:this.s*this.n,d:this.d};},i.fromJSON=function(e){return new i(e);},t.name="Fraction",t.path="type",t.factory=function(e,t,r,n){return i;};},function(i,o,e){var a;/**
...
function factory(type, config, load, typed) {
  var parse = load(__webpack_require__(15));
  var simplify = load(__webpack_require__(55));
  var simplifyConstant = load(__webpack_require__(28));
  var ConstantNode = load(__webpack_require__(10));
  var FunctionNode = load(__webpack_require__(11));
  var OperatorNode = load(__webpack_require__(14));
  var SymbolNode = load(__webpack_require__(7));
...
function factory (type, config, load, typed) {
  ...
  var ArrayNode = load(__webpack_require__(25));
  var matrix = load(__webpack_require__(13));
  var assign = load(__webpack_require__(49));
  var access = load(__webpack_require__(22));
...
function factory (type, config, load, typed) {
  ...
  var compile = load(__webpack_require__(0)).compile;
  var Node = load(__webpack_require__(2));
  var ResultSet = load(__webpack_require__(51));
...
var stringify = __webpack_require__(1).stringify;
var escape = __webpack_require__(1).escape;
var isSafeProperty = __webpack_require__(4).isSafeProperty;
var hasOwnProperty = __webpack_require__(5).hasOwnProperty;
...
function factory (type, config, load, typed, math) {
  ...
  var Node = load(__webpack_require__(2));
  var simplifyConstant = load(__webpack_require__(28));
  var simplifyCore = load(__webpack_require__(56));
  var resolve = load(__webpack_require__(57));
