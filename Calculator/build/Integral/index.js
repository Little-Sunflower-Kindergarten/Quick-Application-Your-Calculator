...
var hasOwnProperty = __webpack_require__(7).hasOwnProperty;
...
var formatNumber = __webpack_require__(11).format;
var formatBigNumber = __webpack_require__(77).format;
var isBigNumber = __webpack_require__(18);
...
var keywords = __webpack_require__(14);
var deepEqual= __webpack_require__(7).deepEqual;
var hasOwnProperty = __webpack_require__(7).hasOwnProperty;
...
var DimensionError = __webpack_require__(21);
var IndexError = __webpack_require__(22);
...
var escape_latex = __webpack_require__(78)
...
var latex = __webpack_require__(8);
var stringify = __webpack_require__(3).stringify;
var escape = __webpack_require__(3).escape;
var hasOwnProperty = __webpack_require__(7).hasOwnProperty;
var getSafeProperty = __webpack_require__(6).getSafeProperty;

function factory (type, config, load, typed, math) {
  var register = load(__webpack_require__(0)).register;
  var compile = load(__webpack_require__(0)).compile;
  var Node = load(__webpack_require__(4));
...
var getType = __webpack_require__(20).type;
var stringify = __webpack_require__(3).stringify;
var escape = __webpack_require__(3).escape;
var escapeLatex = __webpack_require__(8).escape;
...
var validateSafeMethod = __webpack_require__(6).validateSafeMethod;
var getUniqueArgumentName = __webpack_require__(28);
...
var stringify = __webpack_require__(3).stringify;
var escape = __webpack_require__(3).escape;
var isSafeMethod = __webpack_require__(6).isSafeMethod;
var operators = __webpack_require__(10);

function factory (type, config, load, typed) {
  var register = load(__webpack_require__(0)).register;
  var compile = load(__webpack_require__(0)).compile;
  var Node         = load(__webpack_require__(4));
  var ConstantNode = load(__webpack_require__(12));
  var SymbolNode   = load(__webpack_require__(9));
  var FunctionNode = load(__webpack_require__(13));
...
var ArgumentsError = __webpack_require__(74);
var deepMap = __webpack_require__(75);

function factory (type, config, load, typed) {
  var AccessorNode            = load(__webpack_require__(76));
  var ArrayNode               = load(__webpack_require__(27));
  var AssignmentNode          = load(__webpack_require__(80));
  var BlockNode               = load(__webpack_require__(82));
  var ConditionalNode         = load(__webpack_require__(84));
  var ConstantNode            = load(__webpack_require__(12));
  var FunctionAssignmentNode  = load(__webpack_require__(85));
  var IndexNode               = load(__webpack_require__(19));
  var ObjectNode              = load(__webpack_require__(86));
  var OperatorNode            = load(__webpack_require__(16));
  var ParenthesisNode         = load(__webpack_require__(29));
  var FunctionNode            = load(__webpack_require__(13));
  var RangeNode               = load(__webpack_require__(23));
  var SymbolNode              = load(__webpack_require__(9));
...
var errorTransform = __webpack_require__(25).transform;
var getSafeProperty = __webpack_require__(6).getSafeProperty;

function factory (type, config, load, typed) {
  var subset = load(__webpack_require__(26));
...
var clone = __webpack_require__(7).clone;
var validateIndex = __webpack_require__(5).validateIndex;
var getSafeProperty = __webpack_require__(6).getSafeProperty;
var setSafeProperty = __webpack_require__(6).setSafeProperty;
var DimensionError = __webpack_require__(21);

function factory (type, config, load, typed) {
  var matrix = load(__webpack_require__(15));
...
var digits = __webpack_require__(11).digits;
// TODO this could be improved by simplifying seperated constants under associative and commutative operators
function factory(type, config, load, typed, math) {
  var util = load(__webpack_require__(31));
...
_mathMin2.default.import(__webpack_require__(71));
...
exports.default = {
  ...
  set: function set() {
    ...
    _system2.default.set({
      text: _mathMin2.default.format(_mathMin2.default.integral(a1, a2), 15)
    });
  },
  get: function get() {
    var self = this;
...
function factory(type, config, load, typed) {
  var parse = load(__webpack_require__(17));
  var simplify = load(__webpack_require__(87));
  var simplifyConstant = load(__webpack_require__(30));
  var ConstantNode = load(__webpack_require__(12));
  var FunctionNode = load(__webpack_require__(13));
  var OperatorNode = load(__webpack_require__(16));
  var SymbolNode = load(__webpack_require__(9));
...
function factory (type, config, load, typed) {
  ...
  var Node = load(__webpack_require__(4));
  var IndexNode = load(__webpack_require__(19));
  var access = load(__webpack_require__(24));
...
function factory (type, config, load, typed) {
  ...
  var ArrayNode = load(__webpack_require__(27));
  var matrix = load(__webpack_require__(15));
  var assign = load(__webpack_require__(81));
  var access = load(__webpack_require__(24));
...
function factory (type, config, load, typed) {
  ...
  var compile = load(__webpack_require__(0)).compile;
  var Node = load(__webpack_require__(4));
  var ResultSet = load(__webpack_require__(83));
...
var stringify = __webpack_require__(3).stringify;
var escape = __webpack_require__(3).escape;
var isSafeProperty = __webpack_require__(6).isSafeProperty;
var hasOwnProperty = __webpack_require__(7).hasOwnProperty;
...
function factory (type, config, load, typed, math) {
  ...
  var Node = load(__webpack_require__(4));
  var simplifyConstant = load(__webpack_require__(30));
  var simplifyCore = load(__webpack_require__(88));
  var resolve = load(__webpack_require__(89));
